...
class Q_ShareScale_VGG8(nn.Module):
    def __init__(self, time_step, dataset):
        ...
        self.direct_lif = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst,
                                   quant_u=False)
...
class Q_ShareScale_VGG16(nn.Module):
    def __init__(self, time_step, dataset):
        ...
        lif1dvs = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                           num_bits_u=self.num_bits_u)
        ...
        lif7 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                        num_bits_u=self.num_bits_u)
        ...
        lif8 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                        num_bits_u=self.num_bits_u)
        ...
        lif9 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                        num_bits_u=self.num_bits_u)
        ...
        lif10 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                         num_bits_u=self.num_bits_u)
        ...
        lif11 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                         num_bits_u=self.num_bits_u)
        ...
        lif12 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                         num_bits_u=self.num_bits_u)
        ...
        lif13 = LIFSpike(thresh=args.th, leak=args.leak_mem, gamma=1.0, soft_reset=args.sft_rst, quant_u=args.uq,
                         num_bits_u=self.num_bits_u)
